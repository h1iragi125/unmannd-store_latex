...
% 和題("\\"で任意の改行位置を設定可能)
\titleJP{画像処理およびセンサを用いた\\[-1.0em]遠隔在庫把握システムの構築}
% 英題（"\\"で任意の改行位置を設定可能）
\titleEN{Development of a Remote Inventory Monitoring System \\ Using Image Processing and Sensors}
...
% PDFメタデータの設定(任意)
\hypersetup{%
	pdftitle={画像処理およびセンサを用いた遠隔在庫把握システムの構築},				% PDFタイトル
	pdfsubject={Development of a Remote Inventory Monitoring System Using Image Processing and Sensors}					% PDFサブタイトル
