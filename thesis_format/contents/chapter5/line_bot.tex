...
def handle_message(event):
    ...
    \vspace{0.5\baselineskip}
		\begin{figure}[H]
			\centering
			\includegraphics[width=.8\linewidth]{図5.11.png}
			\caption{リッチメニュー設定画面}
			\label{menusettei}
	\end{figure}
    ...
    \vspace{0.5\baselineskip}
		\begin{figure}[H]
			\centering
			\includegraphics[width=.8\linewidth]{図5.12.png}
    ...
    \vspace{0.5\baselineskip}
		\begin{figure}[H]
			\centering
			\includegraphics[width=.8\linewidth]{図5.13.png}
			\caption{応答メッセージ設定画面}
			\label{return}
	\end{figure}
    ...
    \vspace{0.5\baselineskip}
		\begin{figure}[H]
			\centering
			\includegraphics[width=.8\linewidth]{図5.14.png}
			\caption{商品検索の流れ}
			\label{search}
	\end{figure}
    ...
    \vspace{0.5\baselineskip}
		\begin{figure}[H]
			\centering
			\includegraphics[width=.6\linewidth]{図5.15.png}
			\caption{遠隔在庫把握の結果}
			\label{result}
	\end{figure}
